  ...
  return (
    <>
      <div className="home fade-in">
        ...
        <div className="home-section-text home-section-text-3"><div className="logo"><img src={AboutPageImg3} alt="icon 2 - tablet"/></div><p><span className="font-marketing-colour">Development</span> using various languages, frameworks and tools for full implementation of web-based apps.</p></div>        
      </div>
    </>
  )
}
