    ...
    <>    
      <div className="code-chambers fade-in">
        ...
        <div>
          ...
          <p>Creative Chamber is a 'knowledge base' where I will be sharing my current knowledge and experiences in Software Development, creative pursuits within the field including design and UX.</p>
        </div>
